...
const about= {
    ...
    info:[
        {
            fieldName: "Name",
            fieldValue: "Nick Ingargiola"
        },
        {
            fieldName: "Phone",
            fieldValue: "(650) 866-0446"
        },
        {
        ...
        {
            fieldName: "Email",
            fieldValue: "ningargiola1@gmail.com"
        },
    ],
};
                ...
                <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-[60px]">
                    ...
                    <div className="min-h-[70vh] w-full">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {experience.items.map((item, index) => {
                                            return (
                                                <li key={index} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center le:items-start gap-1">
                        ...
                        <div class="flex flex-col gap-[30px] text-center xl:text-left">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {education.itemsList.map((item, index) => {
                                            return (
                                                <li key={index} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center le:items-start gap-1">
                                                    <span className="text-accent">{item.duration}</span>
                        ...
                        <TabsContent value="about" className="w-full text-center xl:text-left">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <p className="max-w-[600px] text-whitle/60 mx-auto xl:mx-0 text-white/60">
                                    {about.description}
                                    </p>
