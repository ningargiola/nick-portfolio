...
const projects = [
    {
        ...
        description:'An AI voice assistant that can perform tasks like finding the weather, playing music, and searching the web.',
        stack: [{name:'Python'}, {name:'Speech Recognition'}, {name:'OpenAI'}],
    ...
    },
    {
        ...
        title:'HoloMat',
        description:'A holographic mat that can be used for home automation, a workbench, and more',
        stack: [{name:'Python'}, {name:'CV2'}, {name:'OpenAI'}],
        image: '/',
        live: "",
        github: "",
    },
    {
        ...
        category:'Game',
        title:'Wordle Clone',
        description:'A clone of the popular game Wordle, built with React',
        stack: [{name:'React'}, {name:'JavaScript'}, {name:'HTML/CSS'}],
        image: '/',
        live: "",
        github: "",
    },
